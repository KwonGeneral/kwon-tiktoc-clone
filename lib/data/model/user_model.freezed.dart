...
@override
String toString() {
  return 'UserModel(id: $id, nickname: $nickname, avatarUrl: $avatarUrl, isVerified: $isVerified, followingCount: $followingCount, followerCount: $followerCount, likeCount: $likeCount)';
}
...
class _UserModel extends UserModel {
  const _UserModel({required this.id, required this.nickname, this.avatarUrl = '', this.isVerified = false, this.followingCount = 0, this.followerCount = 0, this.likeCount = 0}): super._();
