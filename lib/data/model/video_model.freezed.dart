...
@override
String toString() {
  return 'VideoModel(id: $id, userId: $userId, videoUrl: $videoUrl, thumbnailUrl: $thumbnailUrl, description: $description, musicName: $musicName, username: $username, nickname: $nickname, avatarUrl: $avatarUrl, likeCount: $likeCount, commentCount: $commentCount, bookmarkCount: $bookmarkCount, shareCount: $shareCount, isLiked: $isLiked, isBookmarked: $isBookmarked, createdAt: $createdAt)';
}
...
class _VideoModel extends VideoModel {
  const _VideoModel({required this.id, required this.userId, required this.videoUrl, this.thumbnailUrl = '', this.description = '', this.musicName = '', this.username = '', this.nickname = '', this.avatarUrl = '', this.likeCount = 0, this.commentCount = 0, this.bookmarkCount = 0, this.shareCount = 0, this.isLiked = false, this.isBookmarked = false, required this.createdAt}): super._();
