...
@override
String toString() {
  return 'Video(id: $id, userId: $userId, videoUrl: $videoUrl, hlsUrl: $hlsUrl, thumbnailUrl: $thumbnailUrl, description: $description, musicName: $musicName, username: $username, nickname: $nickname, avatarUrl: $avatarUrl, likeCount: $likeCount, commentCount: $commentCount, bookmarkCount: $bookmarkCount, shareCount: $shareCount, isLiked: $isLiked, isBookmarked: $isBookmarked, createdAt: $createdAt)';
}
